...
const createOrderQuery = `INSERT INTO orders ("id", "user", "status", "accural", "upload_time") VALUES ($1, $2, 'NEW', 0, current_timestamp);`
...
const getAllOrdersQuery = `SELECT * FROM orders WHERE "user" = $1 ORDER BY upload_time;`
